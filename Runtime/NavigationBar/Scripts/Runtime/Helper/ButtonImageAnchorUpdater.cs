...
namespace Boshphelm.NavigationBars
{
    public class ButtonImageAnchorUpdater : MonoBehaviour
    {
        ...
        public AnchorUpdater GenerateToLowerAnchorUpdater() => new AnchorUpdater(_target, _lowerAnchorMin, _lowerAnchorMax);
        public AnchorUpdater GenerateToUpperAnchorUpdater() => new AnchorUpdater(_target, _upperAnchorMin, _upperAnchorMax);
    }
}
